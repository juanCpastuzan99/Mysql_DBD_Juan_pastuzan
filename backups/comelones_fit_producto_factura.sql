...
--
-- Host: 127.0.0.1    Database: comelones_fit
-- ------------------------------------------------------
...
CREATE TABLE `producto_factura` (
  ...
  CONSTRAINT `producto_factura_ibfk_1` FOREIGN KEY (`idproducto`) REFERENCES `producto` (`idproducto`),
  CONSTRAINT `producto_factura_ibfk_2` FOREIGN KEY (`idfactura`) REFERENCES `factura` (`idfactura`)
...
-- Dump completed on 2024-09-06 22:23:01
